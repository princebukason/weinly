        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4">
          ...
          <section className="rounded-3xl border border-[#24483f]/20 bg-[#24483f] p-6 md:p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/#main-tabs"
                className="inline-flex items-center rounded-xl bg-[#f59e0b] text-[#1a2e1a] px-8 py-3.5 text-sm font-bold text-white no-underline shadow-lg transition-all hover:opacity-90">
                Submit free request →
              </Link>
              <a href={whatsappLink} target="_blank" rel="noreferrer"
