  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#111827;border:1px solid rgba(255,255,255,0.07);border-radius:24px;padding:32px;margin-bottom:16px;">
      <div style="display:inline-block;background:rgba(52,211,153,0.1);border:1px solid rgba(52,211,153,0.2);border-radius:999px;padding:6px 14px;margin-bottom:20px;">
        <span style="color:#34d399;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;">Request confirmed</span>
      </div>
      ...
      <div style="background:rgba(251,191,36,0.06);border:1px solid rgba(251,191,36,0.2);border-radius:14px;padding:16px;margin-bottom:16px;">
        <div style="color:#fbbf24;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:6px;">⚠ Save this — your Request ID</div>
        <div style="color:#fde68a;font-size:13px;font-weight:700;word-break:break-all;font-family:monospace;margin-bottom:6px;">${requestId}</div>
        <div style="color:#94a3b8;font-size:12px;line-height:1.6;">You need this ID to track your quotes. Keep this email safe.</div>
      </div>
      ...
      <p style="margin:0;color:#64748b;font-size:13px;line-height:1.6;text-align:center;">
        You will receive another email as soon as supplier quotes are ready.
      </p>
    </div>
    ...
    <div style="text-align:center;padding:16px;">
      ...
      <div style="margin-top:16px;padding-top:16px;border-top:1px solid rgba(255,255,255,0.06);">
        <p style="margin:0;color:#334155;font-size:11px;line-height:1.6;">
          You received this because you submitted a request on Weinly.<br/>
