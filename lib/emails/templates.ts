export function quotesReadyEmail(buyerName: string, requestId: string, quoteCount: number) {
  return {
    subject: `Your fabric quotes are ready — ${quoteCount} supplier${quoteCount === 1 ? "" : "s"} matched`,
    html: `
<!DOCTYPE html>
<html>
<head>
  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#111827;border:1px solid rgba(255,255,255,0.07);border-radius:24px;padding:32px;margin-bottom:16px;">
      ...
      <p style="margin:0 0 20px;color:#94a3b8;font-size:15px;line-height:1.7;">
        Hi ${buyerName || "there"}, great news! <strong style="color:#f1f5f9;">${quoteCount} verified supplier${quoteCount === 1 ? " has" : "s have"}</strong> responded to your fabric sourcing request with quotes including price, MOQ and lead time.
      </p>
      ...
      <a href="https://weinlyhq.com/?requestId=${requestId}" style="display:block;background:linear-gradient(135deg,#6366f1,#4f46e5);color:white;text-decoration:none;border-radius:12px;padding:14px 24px;font-weight:700;font-size:15px;text-align:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(99,102,241,0.3);">
        View your quotes →
      </a>

      <p style="margin:0;color:#64748b;font-size:13px;line-height:1.6;text-align:center;">
        Review supplier quotes first. Only pay ₦10,000 when you're ready to unlock direct supplier contact.
      </p>
    </div>
    ...
    <div style="background:#111827;border:1px solid rgba(255,255,255,0.07);border-radius:24px;padding:24px;margin-bottom:16px;">
      ...
      ${["Review supplier quotes — see price, MOQ and lead time", "Choose a supplier you want to work with", "Pay ₦10,000 to unlock their direct contact details", "Contact the supplier directly and negotiate your deal"].map((step, i) => `
    ...
    <div style="text-align:center;padding:16px;">
      ...
      <p style="margin:16px 0 0;color:#334155;font-size:11px;">© 2026 Weinly · Built for fabric buyers sourcing from China</p>
    </div>
...
export function contactApprovedEmail(buyerName: string, requestId: string) {
  return {
    subject: "Supplier contact released — you can now reach your supplier directly",
    html: `
<!DOCTYPE html>
<html>
<head>
    ...
    <div style="background:#111827;border:1px solid rgba(255,255,255,0.07);border-radius:24px;padding:32px;margin-bottom:16px;">
      ...
      <div style="background:rgba(52,211,153,0.06);border:1px solid rgba(52,211,153,0.2);border-radius:14px;padding:16px;margin-bottom:24px;">
        <div style="color:#6ee7b7;font-size:13px;line-height:1.6;">
          Log in to your Weinly account to view the supplier's direct contact details — phone, WeChat and email are now visible on your request tracker.
        </div>
      </div>

      <a href="https://weinlyhq.com/?requestId=${requestId}" style="display:block;background:linear-gradient(135deg,#059669,#34d399);color:white;text-decoration:none;border-radius:12px;padding:14px 24px;font-weight:700;font-size:15px;text-align:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(52,211,153,0.25);">
...
export function newRequestSupplierEmail(
  ...
  return {
    subject: "New fabric sourcing request — a buyer needs your quote",
    html: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background:#0a0f1e;font-family:Inter,ui-sans-serif,system-ui,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#111827;border:1px solid rgba(255,255,255,0.07);border-radius:24px;padding:32px;margin-bottom:16px;">
      ...
      <p style="margin:0 0 20px;color:#94a3b8;font-size:15px;line-height:1.7;">
        Hi ${supplierName}, a new fabric sourcing request has been submitted on Weinly. Log in to your supplier dashboard to review the full details and submit your quote.
      </p>
      ...
      <a href="https://weinlyhq.com/supplier/dashboard" style="display:block;background:linear-gradient(135deg,#f59e0b,#d97706);color:white;text-decoration:none;border-radius:12px;padding:14px 24px;font-weight:700;font-size:15px;text-align:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(245,158,11,0.3);">
        Submit your quote →
      </a>

      <p style="margin:0;color:#64748b;font-size:13px;line-height:1.6;text-align:center;">
        Log in to your supplier dashboard to see the full request details and submit a competitive quote.
      </p>
    </div>
    ...
    <div style="text-align:center;padding:16px;">
      ...
      <p style="margin:16px 0 0;color:#334155;font-size:11px;">© 2026 Weinly · Supplier Portal</p>
    </div>
